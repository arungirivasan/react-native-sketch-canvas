...
RCT_EXPORT_METHOD(addPath:(NSString*) pathId strokeColor: (UIColor*) strokeColor strokeWidth: (int) strokeWidth points: (NSArray*) points)
{
...
RCT_EXPORT_METHOD(newPath:(NSString*) pathId strokeColor: (UIColor*) strokeColor strokeWidth: (int) strokeWidth)
{
    [self runCanvas:reactTag block:^(RNSketchCanvas *canvas) {
...
RCT_EXPORT_METHOD(deletePath:(NSString*) pathId)
{
    [self runCanvas:reactTag block:^(RNSketchCanvas *canvas) {
